...
)
{
        ...
        if($S1 -ne $null)
        {
            if($S1.databases[$bd1] -ne $null)
            {
                ...
                $res1=$tab1 | Where-Object {$_.Schema -eq $sch1}
                if($res1.Count -eq 0)
                {
        ...
        if($S2 -ne $null)
        {
            if($S2.databases[$bd2] -ne $null)
            {
                ...
                $res2=$tab2 | Where-Object {$_.Schema -eq $sch2}
                $res2=$S2.databases[$bd2].Tables |  Where-Object {$_.Schema -eq $sch2 -and $_.Name -eq $TableName2} 
                if($res2.Count -eq 0)
                {
...
$srv1="PRDAMATWSQL01\RPA_DEV"
$srv2="UATDTOWSQL04"
$bd1="DTO_DB"
$bd2="DTO_DB"
$sch1="dbo"
$sch2="dbo"
$TableName1="SHOV_Charity_ExceptionList"
$TableName2="SHOV_Charity_ExceptionList"
#function call
